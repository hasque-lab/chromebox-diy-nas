...
<table>
  <tr>
    <td width="60%">
      <img src="pictures/AC5.png" alt="AC input socket listing example" width="100%">
      <br>
      <sub>Example listing</sub>
    </td>
    <td width="40%">
      <img src="pictures/AC6.png" alt="AC input socket seller dimension reference" width="100%">
      <br>
