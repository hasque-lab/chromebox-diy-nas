...
![screenshot](pictures/wiring4.jpg)
...
<table>
  <tr>
    <td width="50%">
      <img src="pictures/wiring3.jpg" alt="Removing JST VH crimped terminals from connector housing" width="100%">
      <br>
      <sub>Removing wires from the original connector housing</sub>
    </td>
    <td width="50%">
      <img src="pictures/wiring2.jpg" alt="Reassembled JST VH wire harness with required color order" width="100%">
      <br>
