...
<table>
  <tr>
    <td width="65%">
      <img src="pictures/HDD_Shock_Absorption6.jpg" alt="AliExpress listing example for 3.5 HDD rubber rails" width="100%">
      <br>
...
<table>
  <tr>
    <td width="50%">
      <img src="pictures/HDD_Shock_Absorption2.jpg" alt="3.5 HDD rubber rail length measurement" width="100%">
      <br>
      <sub>Length measurement</sub>
    </td>
    <td width="50%">
      <img src="pictures/HDD_Shock_Absorption3.jpg" alt="3.5 HDD rubber rail first width measurement" width="100%">
      <br>
  ...
  <tr>
    <td width="50%">
      <img src="pictures/HDD_Shock_Absorption4.jpg" alt="3.5 HDD rubber rail second width measurement" width="100%">
      <br>
      <sub>Width 2 measurement</sub>
    </td>
    <td width="50%">
      <img src="pictures/HDD_Shock_Absorption1.jpg" alt="3.5 HDD rubber rails on table" width="100%">
      <br>
